import { Search, ShoppingBag, Apple, Pill, Home as HomeIcon, Wrench, ArrowLeft } from "lucide-react";
      ...
      <div className="p-4 grid grid-cols-2 gap-4">
        {categories.map((category) => (
          <button
            ...
            className="bg-card rounded-2xl p-6 border border-border hover:shadow-md transition-all active:scale-95 text-left min-h-[120px]"
          >
